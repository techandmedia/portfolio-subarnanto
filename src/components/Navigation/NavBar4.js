  ...
  render() {
    ...
    return (
      <Navbar color="primary" dark expand="lg">
        <NavbarBrand className="navbar-brand text-white"
        ...
        <Collapse isOpen={this.state.isOpen} navbar className="navbar-right-menu">
          <Nav className="ml-auto" navbar>
            ...
            <UncontrolledDropdown className="dropdown nav-item">
